...
class ArtifactFix {
	...
	static public function artifactFix(Graphic:Dynamic, FrameWidth:Int, FrameHeight:Int):TextureRegion {
		var cached:CachedGraphics = FlxG.bitmap.add(Graphic, false);
		
		var cont:BitmapData = returnContainer(cached.bitmap.width, cached.bitmap.height, FrameWidth, FrameHeight);
		placeTiles(cached.bitmap, cont, FrameWidth, FrameHeight);
		placeSafePixelColumn(cached.bitmap, cont, FrameWidth, FrameHeight);
	...
	static private function placeSafePixelColumn(Source:BitmapData, Dest:BitmapData,
		TileWidth:Int, TileHeight:Int):Void {
		var border:Int = 1;
	...
	static private function placeTiles(Source:BitmapData, Dest:BitmapData, TileWidth:Int, TileHeight:Int):Void {
		var border:Int = 1;
		var x_tot:Int = Std.int(Source.width / TileWidth);
		var y_tot:Int = Std.int(Source.height / TileHeight);
		var x_count:Int = 0;
	...
	static private function returnContainer(Width:Int, Height:Int, TileWidth:Int, TileHeight:Int):BitmapData {
